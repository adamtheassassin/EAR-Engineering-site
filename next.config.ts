  ...
  async redirects() {
    return [
      ...
      },
      {
        ...
        destination: '/ac-repair',
        permanent: true,
      },
      {
        source: '/services/commercial-air-conditioning',
        destination: '/commercial-air-conditioning',
        permanent: true,
      },
      {
      ...
      },
      {
        ...
        destination: '/electrical-services/:path*',
        permanent: true,
      },
      {
      ...
      {
        source: '/wp-content/uploads/2024/02/900070.pdf',
        destination: '/services',
        permanent: true,
      },
      {
